      ...
      <section id="certifications" className="w-full px-6 py-24 md:px-16 flex flex-col items-center text-center relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl">
          {certifications.map((cert, index) => (
            <div
              key={index}
              className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-5 shadow-[0_0_20px_rgba(0,255,255,0.1)] hover:shadow-[0_0_30px_rgba(0,255,255,0.3)] hover:scale-[1.01] transition-all duration-500 fade-in-zoom"
            >
