...
const About = () => {
  return (
    ...
    >
      ...
      <div className="w-full max-w-md sm:max-w-2xl md:max-w-3xl bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-5 sm:p-6 md:p-8 shadow-[0_0_20px_rgba(0,255,255,0.1)] hover:shadow-[0_0_35px_rgba(0,255,255,0.25)] hover:scale-[1.01] transition-all duration-300 text-left">
